  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-4 sm:py-5 flex items-center justify-between">
          ...
          <Link
            ...
            className="
              ...
              text-white font-medium text-sm sm:text-base rounded-full
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-handwriting text-gray-900 mb-2">
            Your Memories
          </h2>
        ...
        {!loading && !error && events.length === 0 && (
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-6">
              Start creating your first digital scrapbook
            </p>
            <Link
              href="/create"
              className="
      ...
      <nav className="fixed bottom-0 inset-x-0 bg-white border-t border-gray-200 pb-safe sm:hidden">
        <div className="flex justify-around items-center py-2">
          <Link
            href="/events"
            className="flex flex-col items-center gap-1 px-4 py-2 text-pink-600"
          >
          ...
          >
            <div className="w-12 h-12 -mt-6 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center shadow-lg">
